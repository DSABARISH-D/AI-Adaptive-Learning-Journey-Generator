...
export function Sidebar() {
  ...
  const navItems = [
    ...
    },
    {
      ...
      path: '/courses',
      icon: (
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H20v20H6.5a2.5 2.5 0 0 1-2.5-2.5Z"/><path d="M6 6h10"/><path d="M6 10h10"/></svg>
      )
    },
    {
    ...
    },
    {
      ...
      path: '/tutor',
      icon: (
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><path d="M8 14s1.5 2 4 2 4-2 4-2"/><line x1="9" y1="9" x2="9.01" y2="9"/><line x1="15" y1="9" x2="15.01" y2="9"/><path d="M12 2v2"/></svg>
      )
    },
    {
  ...
  return (
    <aside className="sidebar">
      {/* Brand matching reference screenshot */}
      <div className="sidebar-brand">
        ...
        <div className="sidebar-brand-text">
          <span className="brand-title">Adaptive Learner</span>
      ...
      {/* Sidebar footer: "Need help? Ask our AI Tutor" matching screenshots */}
      <div className="sidebar-footer">
        <div className="sidebar-tutor-card">
          <div className="tutor-avatar-wrap">
            <div className="tutor-robot-icon">
          ...
          <p className="tutor-prompt">Need help?<br /><strong>Ask our AI Tutor</strong></p>
          <Link to="/tutor" className="tutor-chat-btn">
            Start Chat →
          </Link>
        </div>

        <button onClick={logout} className="sidebar-logout" type="button" title="Sign out">
